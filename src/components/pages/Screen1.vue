<template>
  <NucGridPage v-bind:gap="{'col':0,'row':0}" v-bind:rows="[1]"
    ...
    <NucGridCell v-bind:wrap="true" v-bind:reverse="false" overflow="hidden" direction="column"
      ...
      id="0e199868-5ca7-4c9b-adc8-695232ae51f0" v-bind:col="0" v-bind:row="0" v-bind:colSpan="1" v-bind:rowSpan="1"
      ...
      <WDangerButton tag="button" top="31.993124943275344%" left="45.92042892916038%" v-bind:pill="false" size="md"
        text="Danger" type="button" v-bind:block="false" color="" v-bind:snapX="false" v-bind:snapY="false"
        theme="theme--light01" v-bind:squared="false" variant="danger" position="absolute" v-bind:isEnabled="true"
        background="" borderColor="" ncTypography="body1" v-bind:resetTrigger="false" ncTooltipText=""
        verticalWidth="60px"
        ...
        ncClickBorderColor="#4285f4" ncDisableFontColor="#FFFFFF" ncFocusBorderColor="#4285f4"
